...
namespace GraGasJM.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 1, new DateTime(2026, 6, 8, 15, 1, 36, 159, DateTimeKind.Local).AddTicks(8555), "Botijão de gás GLP 13kg", 5, "Botijão de Gás P13", 90.00m, 115.00m, 20 },
                    { 2, true, 2, new DateTime(2026, 6, 8, 15, 1, 36, 159, DateTimeKind.Local).AddTicks(8561), "Galão de água mineral 20 litros", 10, "Galão de Água Mineral 20L", 12.00m, 18.00m, 30 },
                    { 3, true, 3, new DateTime(2026, 6, 8, 15, 1, 36, 159, DateTimeKind.Local).AddTicks(8565), "Saco de carvão vegetal para churrasco", 5, "Saco de Carvão", 16.00m, 25.00m, 15 }
                });
